...
const listRating: React.FC<SlideShowProps> = () => {
  return (
    <View style={$container}>
        <View style={$reviewHeader}>
            <Text
                tx="listReview.title"
                style={$reviewHeaderTitle}
            />
            <View style={$header}>
        ...
        <View style={$reviewContainer}>
            ...
            >Amazing</Text>
            <Text>
                An amazing fit. i am somewhere around 6ft and ordered 40 size. It's a perfect fit and quality is worth
            </Text>
            <Text
                style={$reviewDate}
                >
                TrungDOng, 31th Jan 2024
            </Text>
        </View>
